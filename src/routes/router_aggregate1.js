...
router.post('/count-courses-by-level', asyncRoute(async (req, res) => {
...
router.post('/count-students-by-course', asyncRoute(async (req, res) => {
...
router.post('/total-duration-by-course', asyncRoute(async (req, res) => {
